locals {
  ...
  backend_address_pool_name      = "${local.stack_name}-beap"
  http_setting_name              = "${local.stack_name}-be-htst"
  request_routing_rule_name      = "${local.stack_name}-rqrt"
  redirect_configuration_name    = "${local.stack_name}-rdrcfg"
